...
export default function Create({ policies = [], companies = [], branches = [], designations = [], employmentTypes = [], users = [], errors = {} }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route('hr.leave.assignments.store'));
    }

    return (
        <HRLayout
            heading="Create Leave Policy Assignment"
            subheading="Assign a leave policy to organization scope or employee."
        >
            <Head title="Create Leave Policy Assignment" />
