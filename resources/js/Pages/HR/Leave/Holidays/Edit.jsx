...
export default function Edit({ holiday, errors = {} }) {
    ...
    function submit(e) {
        e.preventDefault();
        put(route('hr.leave.holidays.update', holiday.id));
    }

    return (
        <HRLayout
            heading="Edit Holiday"
            subheading="Update holiday configuration."
        >
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    >
                        {processing ? 'Saving...' : 'Update Holiday'}
                    </button>
                </div>
            </form>
        </HRLayout>
