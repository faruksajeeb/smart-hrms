...
export default function Create({ leaveTypes = [], users = [], errors = {} }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route('hr.leave.opening-balances.store'));
    }

    return (
        <HRLayout
            heading="Create Leave Opening Balance"
            subheading="Import or manually enter employee leave opening balances."
        >
            <Head title="Create Leave Opening Balance" />
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    ...
                    >
                        {processing ? 'Saving...' : 'Create Opening Balance'}
                    </button>
                </div>
            </form>
        </HRLayout>
