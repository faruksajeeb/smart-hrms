...
export default function Form({
    ...
    const { data, setData, put, post, processing, errors } = useForm({
        ...
        assignment_type: assignment?.assignment_type ?? "initial",
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="font-semibold">
                                {currentAssignment.manager?.name}
                            </p>
                        </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
                <div className="border-b border-slate-200 px-6 py-4">
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Select employee and assign a reporting manager.
                    </p>
                </div>
                ...
                <div className="flex gap-3">
                    ...
                    <div>
                        ...
                        <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-blue-800">
                            ...
                            <li>
                                Circular reporting is not allowed (A cannot
                                report to B if B reports to A).
                            </li>
