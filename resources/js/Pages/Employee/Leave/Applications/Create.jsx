                    ...
                    <div className="rounded-2xl border border-sky-200 bg-sky-50">
                        <div className="border-b border-sky-200 px-5 py-4">
                            <h4 className="text-sm font-medium text-sky-900">
                                Applicable Leave Policy For You
                            </h4>
                            <p className="mt-1 text-sm text-sky-700">
                                {activePolicy.policy_name}
                            </p>
                            <p className="text-xs text-sky-600">
                                {activePolicy.policy_code} | Effective:{" "}
                                {activePolicy.effective_from}{" "}
                                {activePolicy.effective_to
                                    ? `to ${activePolicy.effective_to}`
                                    : ""}
                            </p>
                        </div>
                                        ...
                                        <table className="min-w-full divide-y divide-sky-100 text-xs">
                                            ...
                                            <tbody className="divide-y divide-sky-100 bg-white/70">
                                                {policyDetails.map((detail) => (
                                                    ...
                                                    >
                                                        <td className="px-3 py-2 font-medium text-sky-900">
                                                            {detail.leave_type
                                                                ?.leave_name ||
                                                                "Unknown"}
                                                        </td>
                                                        ...
                                                        <td className="px-3 py-2 text-sky-700">
                                                            {
                                                                detail.minimum_days_per_application
                                                            }{" "}
                                                            -{" "}
                                                            {detail.maximum_days_per_application ||
                                                                "∞"}
                                                        </td>
                                                        <td className="px-3 py-2 text-sky-700">
                                                            {
                            ...
                            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                                ...
                                <div className={delegateRequired ? "lg:col-span-2" : ""}>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) =>
                                            setData("delegate_user_id", e.target.value)
                                        }
                                        className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2"
                                    >
                                        <option value="">
                                ...
                                {selectedPolicyDetail?.attachment_required && (
                                    <div className="lg:col-span-2">
                                        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
                                            <span className="font-semibold">Attachment Required:</span>{" "}
                                            You can upload the required document after saving the draft.
                                            {selectedPolicyDetail.attachment_document_type && (
                                                <> Document type: <span className="font-medium">{selectedPolicyDetail.attachment_document_type}</span></>
                                            )}
                                        </div>
                                    </div>
                                )}
